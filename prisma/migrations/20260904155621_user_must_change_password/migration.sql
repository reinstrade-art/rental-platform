...
INSERT INTO "new_User" ("approvalLevel", "consentVersion", "consentedAt", "createdAt", "disabledAt", "email", "id", "organizationId", "passwordHash", "phone", "propertyId", "role", "tenantId", "vendorId") SELECT "approvalLevel", "consentVersion", "consentedAt", "createdAt", "disabledAt", "email", "id", "organizationId", "passwordHash", "phone", "propertyId", "role", "tenantId", "vendorId" FROM "User";
DROP TABLE "User";
